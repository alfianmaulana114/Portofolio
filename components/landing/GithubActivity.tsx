                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                    <div className="bg-card/50 backdrop-blur-sm border border-border rounded-xl p-5 flex items-center justify-between group">
                        <div>
                            ...
                            <p className="text-3xl font-black font-mono tracking-tighter">{stats?.public_repos || 0}</p>
                        </div>
                    ...
                    <div className="bg-card/50 backdrop-blur-sm border border-border rounded-xl p-5 flex items-center justify-between group">
                        <div>
                            ...
                            <p className="text-3xl font-black font-mono tracking-tighter">{totalContributions}</p>
                        </div>
