export default function About() {
  return (
    <section id="about" className="py-20 mt-20 bg-transparent relative overflow-hidden">
      {/* Decorative Binary Background Fragment */}
      <div className="absolute top-10 right-[-20px] font-black text-[60px] opacity-[0.03] select-none rotate-12 hidden md:block">
        01010110
      </div>
      <div className="absolute bottom-10 left-[-20px] font-black text-[60px] opacity-[0.03] select-none -rotate-12 hidden md:block">
        {"<Dev />"}
      </div>

      <div className="container mx-auto max-w-[800px] px-4 md:px-8 relative z-10">
        <div className="flex flex-col items-center mb-10 text-center">
          <h2 className="text-4xl font-black mb-3 tracking-tighter uppercase">TENTANG SAYA</h2>
        ...
        <div className="relative group">
          ...
          <div className="relative bg-white p-6 md:p-8 border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-1 hover:translate-y-1 transition-all duration-300">
            <p className="text-base md:text-lg font-bold text-gray-800 leading-relaxed text-center md:text-left">
